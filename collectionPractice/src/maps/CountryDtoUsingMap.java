package maps;
 ...
 //loadfactor -.75 or 75% it will increase the size if its full
//key is object
//value is object
...
//key can be null
//values can be null
//multiple null cannot be added to key
...
//datastructure is hashmap for linkedlist+hashmap  linkedhashmap

import java.util.HashMap;
import java.util.Map;
import java.util.Set;

public class CountryDtoUsingMap {
...
//        System.out.println("clearing the key and values!!!!!!!!!!!!!!!!!!!!!");
//        map.clear();
//        System.out.println(map);

        Set<Object> keys =map.keySet();
        for (Object key : keys) {
            CountryDto countryDto = (CountryDto) map.get(key);
