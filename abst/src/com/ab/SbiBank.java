...
public class SbiBank implements Bank{
    ...
    public String openAccount(String branchName, int accNo) {
        System.out.println("SBI account is created successfully");
        this.branchName=branchName;
        this.accNo=accNo;
        return "SBI branch name-"+branchName+"SBI accNO-"+accNo;
    }

    @Override
    public String closeAccount(int accNo) {
        if(this.accNo==accNo){
            System.out.println("SBI account is closed successfully");
        }
        else{
            System.out.println("entered incorrect account number ");
        }
        return "SBI  closed successfully";
    }
