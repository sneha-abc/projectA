...
public class IcscBank implements Bank{
    String branchName;
    int accNo;
    int balanceAmount;
    ...
    public String openAccount(String branchName, int accNo) {
        System.out.println("ICSCbank account is created successfully");
        this.branchName=branchName;
        this.accNo=accNo;
        return "ICSCbank branch name-"+branchName+"ICSCbank accNO-"+accNo;
    }

    @Override
    public String closeAccount(int accNo) {
        if(this.accNo==accNo){
            System.out.println("ICSCbank account is closed successfully");
        }
        else{
            System.out.println("entered incorrect account number ");
        }
        return "ICSCbank  closed successfully";
    }
