...
public class ArrayList5 {
    public static void main(String[] args){
        ...
        arrayList.add("iphone");//adding an element to the array list
        ...
        arrayList.add(5,"sneha");//adding the element in the index 5 and all the elements shift by next index
        ...
        arrayList.set(1,"apple ");//replace the old element to new element in same index length of the array remains same
        System.out.println(arrayList);

        System.out.println("index of value is " + arrayList.indexOf("samsung"));//fetching the index based on element
        ...
        System.out.println("index of value is " + arrayList.indexOf("redmi"));
        System.out.println(arrayList.lastIndexOf("iq7"));
